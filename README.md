...
│
├── images/             # Folder for image gallery and logos
│   ├── logo.png
│   ├── room-1.jpg
│   └── background.jpg
│
...
**🌐 Live Preview:**
   ```bash
   [[https://github.com/Senulr1/Seetha-Hotel-Web-.git](https://github.com/Senulr1/Seetha-Hotel-Web-.git)](https://senulr1.github.io/Seetha-Hotel-Web-/index.html)
   ```
